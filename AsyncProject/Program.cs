    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var asyncScenarios = new AsyncScenarios())
            {
                ...
                stopwatch.Stop();
                WriteLine($"ASYNC - Completed in {stopwatch.ElapsedMilliseconds} ms" + Environment.NewLine);
            }
            ...
            using (var syncScenarios = new SyncScenarios())
            {
                ...
                stopwatch.Stop();
                WriteLine($"SYNC - Completed in {stopwatch.ElapsedMilliseconds} ms" + Environment.NewLine);
            }
